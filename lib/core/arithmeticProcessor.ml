...
(Sum1 (1*x) (2*y) (2*z) \/ Sum2 (2*x) (4*y) (4*z))

constraints: (1*x')=((1*x)+(N0*(-1))),(2*y')=((2*y)+(N0*(-1))),(2*z')=((2*z)+(N0*(-2)))
source: Sum2
Dest: Sum2
n: N1
times: (0+(4*N1))
constraints: (2*x')=((2*x)+(N1*(-1))),(4*y')=((4*y)+(N1*(-1))),(4*z')=((4*z)+(N1*(-2)))
...
All': ((4*(2*z))+(4*(N0*(-2))))=((2*(4*z))+(2*(N1*(-2)))),
      ((4*(2*y))-(4*N0))=((2*(4*y))-(2*N1)),
      ((2*x)-(2*N0))=((2*x)-N1)

Goal: (and (<= 1 (+ 0 N0 N1))
     (= (+ ( * 4 2 z) ( * 4 N0 (- 2))) (+ ( * 2 4 z) ( * 2 N1 (- 2))))
     (= (- ( * 4 2 y) ( * 4 N0)) (- ( * 2 4 y) ( * 2 N1)))
     (= (- ( * 2 x) ( * 2 N0)) (- ( * 2 x) N1)))
Solver: (declare-fun N1 () Int)
(declare-fun N0 () Int)
(assert (<= 1 (+ N0 N1)))
(assert (= ( * (- 8) N0) ( * (- 4) N1)))
(assert (= ( * (- 4) N0) ( * (- 2) N1)))
